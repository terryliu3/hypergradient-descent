...
python train.py --model logreg --method sgd_hd_kt --save --epochs 10 --alpha_0 0.001 --beta 0.001
python old_train.py --model logreg --method sgd_hd  --save --epochs 1 --alpha_0 0.001 --beta 0.001
...
python train.py --model logreg --method adam_hd --save --epochs 10 --alpha_0 0.001 --beta 1e-7
